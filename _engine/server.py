...
from .updater import check_update, apply_update, get_current_version
    ...
    def do_GET(self):
        ...
        if path == "/api/health":
            ...
            self._json_response([
                ...
                {"id":"business","name":"商务写作","icon":"💼","desc":"商业计划书、合同、投标方案、商务邮件","theme":"#1a56db"},
    ...
    def do_POST(self):
        ...
        if path == "/api/documents":
            ...
            if not system_prompt:
                ...
                if not prompt_text:
                    prompt_text = te.get_prompt("通知") or te.get_prompt("通用文章") or ""
            ...
            if engine not in ["deepseek", "openai", "ollama", "custom", "greenapi"]:
            ...
            if engine == "deepseek":
                ...
                config.openai_api_key = body.get("api_key", config.openai_api_key)
